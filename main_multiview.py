...
from modules import generator_final, discriminator_v2, PDLoss
...
parser.add_argument('--pretrained_D', default='GAN_discriminator_00.pth', help='sr pretrained base model')
...
def train(epoch):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        real_label = torch.ones((minibatch, 1500))
        fake_label = torch.zeros((minibatch, 1500))
...
G = generator_final(input_dim=3, dim=64)
# G = generator_v10(input_dim=3, dim=64)
